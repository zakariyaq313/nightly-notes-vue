<template>
    <!-- Reason for separating the navigation in a component 
    instead of placing it within the base component 👇 -->
    
    <!-- It gets re-rendered each time, and the smooth page 
    switching animation on the nav buttons is lost -->
